...
| `always_split_snippets` | `true`, `false` | Whether or not action items should always be rendered in seperate code snippets, even when they are located close to each other in code. | `false` |
